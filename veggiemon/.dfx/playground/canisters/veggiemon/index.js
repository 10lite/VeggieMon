...
import { idlFactory } from './veggiemon.did.js';
export { idlFactory } from './veggiemon.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VEGGIEMON_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./veggiemon.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the veggiemon canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./veggiemon.did.js")._SERVICE>}
 */
export const veggiemon = createActor(canisterId);
